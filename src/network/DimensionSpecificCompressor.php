	...
	public function compress(string $payload) : string{
		...
		foreach($packets as [$packet, $buffer]){
			if($packet instanceof LevelChunkPacket){
				...
				$modified = PacketBatch::fromPackets($context, LevelChunkPacket::create($packet->getChunkX(), $packet->getChunkZ(), $packet->getSubChunkCount() - ChunkSerializer::LOWER_PADDING_SIZE, $packet->getUsedBlobHashes(), $new_payload))->getBuffer();
			}
		}
